...
public class CompanyBusinessDTO implements Serializable, Cloneable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8124580689169740086L;
	 ...
	 * Clones the object
	 */
	public CompanyBusinessDTO clone() throws CloneNotSupportedException {
		return (CompanyBusinessDTO) super.clone();
	}
