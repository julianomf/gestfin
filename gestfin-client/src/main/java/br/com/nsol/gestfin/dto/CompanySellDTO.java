...
public class CompanySellDTO implements Serializable, Cloneable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -9129184344405374667L;
	 ...
	 * Clones the object
	 */
	public CompanySellDTO clone() throws CloneNotSupportedException {
		return (CompanySellDTO) super.clone();
	}
